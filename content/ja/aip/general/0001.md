...
**注:** 正式な事項として、1人のAIP承認者（著者以外）がAIPをreviewing状態に進めるために正式な承認を提供**しなければならない**（must）。さらに、他の承認者からの正式な異議（GitHub PRでの"changes requested"）があっては**ならない**（must not）。

### Approved

承認されたAIPが合意に達すると、"approved"状態になり、"best current practice"と見なされる。

**注:** 正式な事項として、2人のAIP承認者（著者以外）がAIPをapproved状態に進めるために正式な承認を提供**しなければならない**（must）。さらに、他の承認者からの正式な異議（GitHub PRでの"changes requested"）があっては**ならない**（must not）。
